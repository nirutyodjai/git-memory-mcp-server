...
class MCP_BUSINESS_Server {
  constructor() {
    ...
    this.serverId = 'business-3544';
    this.category = 'business';
    this.port = 3544;
    this.memoryPath = 'D:\Ai Server\git-memory-mcp-server\.git-memory\servers\business-3544';
...
const server = new MCP_BUSINESS_Server();
