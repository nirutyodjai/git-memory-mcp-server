...
class MCP_API_Server {
  constructor() {
    ...
    this.serverId = 'api-3213';
    this.category = 'api';
    this.port = 3213;
    this.memoryPath = 'D:\Ai Server\git-memory-mcp-server\.git-memory\servers\api-3213';
...
server.run().catch(console.error);
    ...
    onSharedDataReceived(dataType, serverId, data, metadata) {
        console.log(`📥 [api-3213] Received ${dataType} from ${serverId}`);
    ...
    onSharedChannelMessage(channel, data) {
        console.log(`📢 [api-3213] Channel message on ${channel}:`, data);
