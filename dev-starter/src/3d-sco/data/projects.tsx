    ...
    get content() {
      return (
        <div>
          ...
          <TypographyH3 className="my-4 mt-8">บริการหลัก</TypographyH3>
          <p className="font-mono mb-2">
          ...
          />
          <TypographyH3 className="my-4 mt-8">ผลงานที่โดดเด่น</TypographyH3>
          <p className="font-mono mb-2">
          ...
          />
          <TypographyH3 className="my-4 mt-8">จุดเด่นของบริการ</TypographyH3>
          <p className="font-mono mb-2">
    ...
    get content() {
      return (
        <div>
          ...
          />
          <TypographyH3 className="my-4 ">ธีมอวกาศ</TypographyH3>
          <p className="font-mono mb-2">
            พื้นหลังมืด + อนุภาคลอยน้ำ = ความเจ๋งที่เหนือโลก
          </p>
          <SlideShow images={[`${BASE_PATH}/myportfolio/navbar.png`]} />
          <TypographyH3 className="my-4 mt-8">ผลงาน</TypographyH3>
