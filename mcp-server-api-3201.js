...
class MCP_API_Server {
  constructor() {
    ...
    this.serverId = 'api-3201';
    this.category = 'api';
    this.port = 3201;
    this.memoryPath = 'D:\Ai Server\git-memory-mcp-server\.git-memory\servers\api-3201';
...
server.run().catch(console.error);
    ...
    onSharedDataReceived(dataType, serverId, data, metadata) {
        console.log(`📥 [api-3201] Received ${dataType} from ${serverId}`);
    ...
    onSharedChannelMessage(channel, data) {
        console.log(`📢 [api-3201] Channel message on ${channel}:`, data);
