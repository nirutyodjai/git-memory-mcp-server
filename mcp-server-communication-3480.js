...
class MCP_COMMUNICATION_Server {
  constructor() {
    this.server = new Server(
      {
        name: 'communication-3480',
        version: '1.0.0',
      },
      {
        capabilities: {
    ...
    this.serverId = 'communication-3480';
    this.category = 'communication';
    this.port = 3480;
    this.memoryPath = 'D:\Ai Server\git-memory-mcp-server\.git-memory\servers\communication-3480';
...
const server = new MCP_COMMUNICATION_Server();
