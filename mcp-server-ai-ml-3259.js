...
class MCP_AI-ML_Server {
  constructor() {
    ...
    this.serverId = 'ai-ml-3259';
    this.category = 'ai-ml';
    this.port = 3259;
    this.memoryPath = 'D:\Ai Server\git-memory-mcp-server\.git-memory\servers\ai-ml-3259';
...
server.run().catch(console.error);
    ...
    onSharedDataReceived(dataType, serverId, data, metadata) {
        console.log(`📥 [ai-ml-3259] Received ${dataType} from ${serverId}`);
    ...
    onSharedChannelMessage(channel, data) {
        console.log(`📢 [ai-ml-3259] Channel message on ${channel}:`, data);
