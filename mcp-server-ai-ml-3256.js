...
class MCP_AI-ML_Server {
  constructor() {
    ...
    this.serverId = 'ai-ml-3256';
    this.category = 'ai-ml';
    this.port = 3256;
    this.memoryPath = 'D:\Ai Server\git-memory-mcp-server\.git-memory\servers\ai-ml-3256';
...
const server = new MCP_AI-ML_Server();
server.run().catch(console.error);
    ...
    onSharedDataReceived(dataType, serverId, data, metadata) {
        console.log(`📥 [ai-ml-3256] Received ${dataType} from ${serverId}`);
    ...
    onSharedChannelMessage(channel, data) {
        console.log(`📢 [ai-ml-3256] Channel message on ${channel}:`, data);
    ...
    broadcastToCategory(data) {
        this.sharedIntegration.broadcastToChannel('ai-ml', data);
    }
