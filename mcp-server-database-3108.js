...
class MCP_DATABASE_Server {
  constructor() {
    ...
    this.serverId = 'database-3108';
    this.category = 'database';
    this.port = 3108;
    this.memoryPath = 'D:\Ai Server\git-memory-mcp-server\.git-memory\servers\database-3108';
...
const server = new MCP_DATABASE_Server();
server.run().catch(console.error);
    ...
    onSharedDataReceived(dataType, serverId, data, metadata) {
        console.log(`📥 [database-3108] Received ${dataType} from ${serverId}`);
    ...
    onSharedChannelMessage(channel, data) {
        console.log(`📢 [database-3108] Channel message on ${channel}:`, data);
    ...
    broadcastToCategory(data) {
        this.sharedIntegration.broadcastToChannel('database', data);
    }
