...
class MCP_API_Server {
  constructor() {
    ...
    this.serverId = 'api-3210';
    this.category = 'api';
    this.port = 3210;
    this.memoryPath = 'D:\Ai Server\git-memory-mcp-server\.git-memory\servers\api-3210';
...
server.run().catch(console.error);
    ...
    onSharedDataReceived(dataType, serverId, data, metadata) {
        console.log(`📥 [api-3210] Received ${dataType} from ${serverId}`);
    ...
    onSharedChannelMessage(channel, data) {
        console.log(`📢 [api-3210] Channel message on ${channel}:`, data);
