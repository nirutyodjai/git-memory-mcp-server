...
class MCP_FILESYSTEM_Server {
  constructor() {
    ...
    this.serverId = 'filesystem-3151';
    this.category = 'filesystem';
    this.port = 3151;
    this.memoryPath = 'D:\Ai Server\git-memory-mcp-server\.git-memory\servers\filesystem-3151';
...
server.run().catch(console.error);
    ...
    onSharedDataReceived(dataType, serverId, data, metadata) {
        console.log(`📥 [filesystem-3151] Received ${dataType} from ${serverId}`);
    ...
    onSharedChannelMessage(channel, data) {
        console.log(`📢 [filesystem-3151] Channel message on ${channel}:`, data);
