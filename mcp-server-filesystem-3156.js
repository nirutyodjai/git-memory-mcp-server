...
class MCP_FILESYSTEM_Server {
  constructor() {
    ...
    this.serverId = 'filesystem-3156';
    this.category = 'filesystem';
    this.port = 3156;
    this.memoryPath = 'D:\Ai Server\git-memory-mcp-server\.git-memory\servers\filesystem-3156';
...
server.run().catch(console.error);
    ...
    onSharedDataReceived(dataType, serverId, data, metadata) {
        console.log(`📥 [filesystem-3156] Received ${dataType} from ${serverId}`);
    ...
    onSharedChannelMessage(channel, data) {
        console.log(`📢 [filesystem-3156] Channel message on ${channel}:`, data);
