...
class mcpserverdatabase5002Server {
    constructor() {
        this.name = 'mcp-server-database-5002';
        this.port = 5002;
            ...
            tools: [
                {
                    ...
                    description: 'Perform database operations for mcp-server-database-5002',
                    inputSchema: {
                        type: 'object',
                        properties: {
        ...
        this.server.setRequestHandler(CallToolRequestSchema, async (request) => {
            ...
            if (name === 'database_operation') {
                return {
                    content: [{
                        type: 'text',
                        text: `DATABASE operation '${args.action}' completed successfully on ${this.name}`
                    }]
                };
            }
...
const server = new mcpserverdatabase5002Server();
