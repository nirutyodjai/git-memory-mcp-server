...
class mcpservermonitoring5005Server {
    constructor() {
        this.name = 'mcp-server-monitoring-5005';
        this.port = 5005;
            ...
            tools: [
                {
                    ...
                    description: 'Perform monitoring operations for mcp-server-monitoring-5005',
                    inputSchema: {
                        type: 'object',
                        properties: {
        ...
        this.server.setRequestHandler(CallToolRequestSchema, async (request) => {
            ...
            if (name === 'monitoring_operation') {
                return {
                    content: [{
                        type: 'text',
                        text: `MONITORING operation '${args.action}' completed successfully on ${this.name}`
                    }]
                };
            }
...
const server = new mcpservermonitoring5005Server();
