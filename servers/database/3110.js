...
class MCP_DATABASE_Server {
  constructor() {
    ...
    this.serverId = 'database-3110';
    this.category = 'database';
    this.port = 3110;
    this.healthPort = 4110;
    this.memoryPath = 'D:\\Ai Server\\git-memory-mcp-server\\.git-memory\\servers\\database-3110';
  ...
  setupHealthServer() {
    ...
    this.healthServer = http.createServer(this.healthApp);
  }
  ...
  async run() {
    ...
    this.healthServer.listen(this.healthPort, () => {
      console.log(`${this.serverId} health server running on port ${this.healthPort}`);
    });
