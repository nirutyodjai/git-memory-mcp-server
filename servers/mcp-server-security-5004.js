...
class mcpserversecurity5004Server {
    constructor() {
        this.name = 'mcp-server-security-5004';
        this.port = 5004;
            ...
            tools: [
                {
                    ...
                    description: 'Perform security operations for mcp-server-security-5004',
                    inputSchema: {
                        type: 'object',
                        properties: {
        ...
        this.server.setRequestHandler(CallToolRequestSchema, async (request) => {
            ...
            if (name === 'security_operation') {
                return {
                    content: [{
                        type: 'text',
                        text: `SECURITY operation '${args.action}' completed successfully on ${this.name}`
                    }]
                };
            }
...
const server = new mcpserversecurity5004Server();
