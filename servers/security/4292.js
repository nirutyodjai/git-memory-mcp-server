...
class MCP_SECURITY_Server {
  constructor() {
    ...
    this.serverId = 'security-4292';
    this.category = 'security';
    this.port = 4292;
    this.memoryPath = 'D:\Ai Server\git-memory-mcp-server\.git-memory\servers\security-4292';
...
const server = new MCP_SECURITY_Server();
