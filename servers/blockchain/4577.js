...
class MCP_BLOCKCHAIN_Server {
  constructor() {
    this.server = new Server(
      {
        name: 'blockchain-4577',
        version: '1.0.0',
      },
      {
        capabilities: {
    ...
    this.serverId = 'blockchain-4577';
    this.category = 'blockchain';
    this.port = 4577;
    this.memoryPath = 'D:\Ai Server\git-memory-mcp-server\.git-memory\servers\blockchain-4577';
...
const server = new MCP_BLOCKCHAIN_Server();
