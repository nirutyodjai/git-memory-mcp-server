...
class mcpserverfilesystem5003Server {
    constructor() {
        this.name = 'mcp-server-filesystem-5003';
        this.port = 5003;
            ...
            tools: [
                {
                    ...
                    description: 'Perform filesystem operations for mcp-server-filesystem-5003',
                    inputSchema: {
                        type: 'object',
                        properties: {
        ...
        this.server.setRequestHandler(CallToolRequestSchema, async (request) => {
            ...
            if (name === 'filesystem_operation') {
                return {
                    content: [{
                        type: 'text',
                        text: `FILESYSTEM operation '${args.action}' completed successfully on ${this.name}`
                    }]
                };
            }
...
const server = new mcpserverfilesystem5003Server();
