...
class MCP_IOT-HARDWARE_Server {
  constructor() {
    this.server = new Server(
      {
        name: 'iot-hardware-3578',
        version: '1.0.0',
      },
      {
        capabilities: {
    ...
    this.serverId = 'iot-hardware-3578';
    this.category = 'iot-hardware';
    this.port = 3578;
    this.memoryPath = 'D:\Ai Server\git-memory-mcp-server\.git-memory\servers\iot-hardware-3578';
...
const server = new MCP_IOT-HARDWARE_Server();
