...
class mcpserveranalytics5006Server {
    constructor() {
        this.name = 'mcp-server-analytics-5006';
        this.port = 5006;
            ...
            tools: [
                {
                    ...
                    description: 'Perform analytics operations for mcp-server-analytics-5006',
                    inputSchema: {
                        type: 'object',
                        properties: {
        ...
        this.server.setRequestHandler(CallToolRequestSchema, async (request) => {
            ...
            if (name === 'analytics_operation') {
                return {
                    content: [{
                        type: 'text',
                        text: `ANALYTICS operation '${args.action}' completed successfully on ${this.name}`
                    }]
                };
            }
...
const server = new mcpserveranalytics5006Server();
