...
class MCP_SYSTEM-OPS_Server {
  constructor() {
    this.server = new Server(
      {
        name: 'system-ops-3440',
        version: '1.0.0',
      },
      {
        capabilities: {
    ...
    this.serverId = 'system-ops-3440';
    this.category = 'system-ops';
    this.port = 3440;
    this.memoryPath = 'D:\Ai Server\git-memory-mcp-server\.git-memory\servers\system-ops-3440';
...
const server = new MCP_SYSTEM-OPS_Server();
