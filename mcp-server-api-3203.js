...
class MCP_API_Server {
  constructor() {
    ...
    this.serverId = 'api-3203';
    this.category = 'api';
    this.port = 3203;
    this.memoryPath = 'D:\Ai Server\git-memory-mcp-server\.git-memory\servers\api-3203';
...
server.run().catch(console.error);
    ...
    onSharedDataReceived(dataType, serverId, data, metadata) {
        console.log(`📥 [api-3203] Received ${dataType} from ${serverId}`);
    ...
    onSharedChannelMessage(channel, data) {
        console.log(`📢 [api-3203] Channel message on ${channel}:`, data);
