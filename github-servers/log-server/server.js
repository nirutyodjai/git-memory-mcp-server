...
class LogServerMCP {
    constructor() {
        ...
        this.description = 'Logging and monitoring operations';
        this.category = 'logging';
        this.port = 4011;
        this.capabilities = ["log_info","log_error","log_debug","log_warn","get_logs"];
