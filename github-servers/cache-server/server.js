...
class CacheServerMCP {
    constructor() {
        this.name = 'cache-server';
        this.description = 'In-memory caching and storage';
        this.category = 'cache';
        this.port = 4010;
        this.capabilities = ["cache_set","cache_get","cache_delete","cache_clear","cache_stats"];
...
// Main execution
async function main() {
    const server = new CacheServerMCP();
