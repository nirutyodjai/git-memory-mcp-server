...
class HttpClientServerMCP {
    constructor() {
        this.name = 'http-client-server';
        this.description = 'HTTP client for API calls and web requests';
        this.category = 'web';
        this.port = 4001;
        this.capabilities = ["get_request","post_request","put_request","delete_request","upload_file"];
...
// Main execution
async function main() {
    const server = new HttpClientServerMCP();
...
module.exports = HttpClientServerMCP;
