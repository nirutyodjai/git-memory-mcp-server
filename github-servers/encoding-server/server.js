...
class EncodingServerMCP {
    constructor() {
        this.name = 'encoding-server';
        this.description = 'Data encoding and decoding operations';
        this.category = 'encoding';
        this.port = 4008;
        this.capabilities = ["base64_encode","base64_decode","url_encode","url_decode","html_encode"];
...
// Main execution
async function main() {
    const server = new EncodingServerMCP();
...
module.exports = EncodingServerMCP;
