...
class NotificationServerMCP {
    constructor() {
        this.name = 'notification-server';
        this.description = 'Notification and alerting system';
        this.category = 'notification';
        this.port = 4014;
        this.capabilities = ["send_notification","schedule_notification","cancel_notification","get_notifications","mark_read"];
...
// Main execution
async function main() {
    const server = new NotificationServerMCP();
...
module.exports = NotificationServerMCP;
