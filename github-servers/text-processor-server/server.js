...
class TextProcessorServerMCP {
    constructor() {
        this.name = 'text-processor-server';
        this.description = 'Text processing and manipulation utilities';
        this.category = 'text';
        this.port = 4003;
        this.capabilities = ["search_text","replace_text","split_text","join_text","format_text"];
...
// Main execution
async function main() {
    const server = new TextProcessorServerMCP();
...
module.exports = TextProcessorServerMCP;
