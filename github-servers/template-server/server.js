...
class TemplateServerMCP {
    constructor() {
        this.name = 'template-server';
        this.description = 'Template processing and rendering';
        this.category = 'template';
        this.port = 4009;
        this.capabilities = ["render_template","compile_template","validate_template","list_variables","format_output"];
...
// Main execution
async function main() {
    const server = new TemplateServerMCP();
...
module.exports = TemplateServerMCP;
