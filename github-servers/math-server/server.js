...
class MathServerMCP {
    constructor() {
        this.name = 'math-server';
        this.description = 'Mathematical calculations and operations';
        this.category = 'math';
        this.port = 4006;
        this.capabilities = ["calculate","random_number","statistics","geometry","algebra"];
...
// Main execution
async function main() {
    const server = new MathServerMCP();
