...
class DatetimeServerMCP {
    constructor() {
        this.name = 'datetime-server';
        this.description = 'Date and time operations';
        this.category = 'utility';
        this.port = 4005;
        this.capabilities = ["current_time","format_date","parse_date","add_time","diff_time"];
...
// Main execution
async function main() {
    const server = new DatetimeServerMCP();
...
module.exports = DatetimeServerMCP;
