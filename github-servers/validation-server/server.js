...
class ValidationServerMCP {
    constructor() {
        this.name = 'validation-server';
        this.description = 'Data validation and verification';
        this.category = 'validation';
        this.port = 4007;
        this.capabilities = ["validate_email","validate_url","validate_phone","validate_json","validate_schema"];
...
// Main execution
async function main() {
    const server = new ValidationServerMCP();
...
module.exports = ValidationServerMCP;
