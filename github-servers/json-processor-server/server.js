...
class JsonProcessorServerMCP {
    constructor() {
        this.name = 'json-processor-server';
        this.description = 'JSON data processing and manipulation';
        this.category = 'data';
        this.port = 4002;
        this.capabilities = ["parse_json","stringify_json","validate_json","transform_json","merge_json"];
...
// Main execution
async function main() {
    const server = new JsonProcessorServerMCP();
...
module.exports = JsonProcessorServerMCP;
