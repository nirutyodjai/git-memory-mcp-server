...
class CryptoServerMCP {
    constructor() {
        this.name = 'crypto-server';
        this.description = 'Cryptographic operations and security';
        this.category = 'security';
        this.port = 4004;
        this.capabilities = ["hash_data","encrypt_data","decrypt_data","generate_key","verify_signature"];
...
// Main execution
async function main() {
    const server = new CryptoServerMCP();
...
module.exports = CryptoServerMCP;
