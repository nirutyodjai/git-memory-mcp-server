...
class QueueServerMCP {
    constructor() {
        this.name = 'queue-server';
        this.description = 'Message queue and task processing';
        this.category = 'queue';
        this.port = 4013;
        this.capabilities = ["enqueue","dequeue","peek","queue_size","clear_queue"];
...
// Main execution
async function main() {
    const server = new QueueServerMCP();
