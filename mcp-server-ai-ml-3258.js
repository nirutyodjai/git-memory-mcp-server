...
class MCP_AI-ML_Server {
  constructor() {
    ...
    this.serverId = 'ai-ml-3258';
    this.category = 'ai-ml';
    this.port = 3258;
    this.memoryPath = 'D:\Ai Server\git-memory-mcp-server\.git-memory\servers\ai-ml-3258';
...
server.run().catch(console.error);
    ...
    onSharedDataReceived(dataType, serverId, data, metadata) {
        console.log(`📥 [ai-ml-3258] Received ${dataType} from ${serverId}`);
    ...
    onSharedChannelMessage(channel, data) {
        console.log(`📢 [ai-ml-3258] Channel message on ${channel}:`, data);
