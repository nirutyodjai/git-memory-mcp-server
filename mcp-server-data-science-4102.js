...
class MCP_DATA-SCIENCE_Server {
  constructor() {
    this.server = new Server(
      {
        name: 'data-science-4102',
        version: '1.0.0',
      },
      {
        capabilities: {
    ...
    this.serverId = 'data-science-4102';
    this.category = 'data-science';
    this.port = 4102;
    this.memoryPath = 'D:\Ai Server\git-memory-mcp-server\.git-memory\servers\data-science-4102';
...
const server = new MCP_DATA-SCIENCE_Server();
