...
class MCP_API_Server {
  constructor() {
    ...
    this.serverId = 'api-3211';
    this.category = 'api';
    this.port = 3211;
    this.memoryPath = 'D:\Ai Server\git-memory-mcp-server\.git-memory\servers\api-3211';
...
const server = new MCP_API_Server();
server.run().catch(console.error);
    ...
    onSharedDataReceived(dataType, serverId, data, metadata) {
        console.log(`📥 [api-3211] Received ${dataType} from ${serverId}`);
    ...
    onSharedChannelMessage(channel, data) {
        console.log(`📢 [api-3211] Channel message on ${channel}:`, data);
    ...
    broadcastToCategory(data) {
        this.sharedIntegration.broadcastToChannel('api', data);
    }
