...
class MCP_GAMING_Server {
  constructor() {
    ...
    this.serverId = 'gaming-4412';
    this.category = 'gaming';
    this.port = 4412;
    this.memoryPath = 'D:\Ai Server\git-memory-mcp-server\.git-memory\servers\gaming-4412';
...
const server = new MCP_GAMING_Server();
