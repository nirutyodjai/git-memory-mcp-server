...
import { comdeeCompanyInfo } from "@/data/comdee";
            ...
            <>
              <div className="">
                ...
                <BlurIn delay={1.2}>
                  ...
                  >
                    {comdeeCompanyInfo.tagline}
                  </p>
                </BlurIn>
              </div>
              <div className="mt-8 md:ml-2 flex flex-col gap-3">
                <Link
                  href={comdeeCompanyInfo.website}
                  target="_blank"
                  className="flex-1"
                >
                ...
                <div className="md:self-start flex gap-3">
                  ...
                  <Link
                    href={comdeeCompanyInfo.contact.social.facebook}
                    target="_blank"
                  >
                  ...
                  <Link
                    href={comdeeCompanyInfo.contact.social.line}
                    target="_blank"
                  >
                    <Button variant={"outline"}>
