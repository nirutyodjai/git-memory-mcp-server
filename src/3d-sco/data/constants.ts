...
export const SKILLS: Record<SkillNames, Skill> = {
  ...
  [SkillNames.TS]: {
    ...
    label: "TypeScript",
    shortDescription:
      "ลูกพี่ลูกน้องของ JavaScript ที่ทำงานหนักเกินไปและชอบอวด 💯🔒",
    color: "#007acc",
...
ใช้ use = useUsing("use")`,
  ...
  [SkillNames.VUE]: {
    ...
    label: "Vue",
    shortDescription:
      "ยาสงบสำหรับ frontend ของคุณ มันต่างออกไปจริงๆ! 🟢😌",
    color: "#41b883",
  ...
  [SkillNames.NEXTJS]: {
    ...
    label: "Next.js",
    shortDescription:
      "ราชินีแห่งดราม่าของ front-end frameworks และเราก็รักมัน! 👑📜",
    color: "#fff",
  ...
  [SkillNames.FIREBASE]: {
    ...
    label: "Firebase",
    shortDescription:
      "เพื่อนซี้สุดยอดของแอปคุณ แต่ระวังการติดกับผู้ให้บริการ! 🔥👌",
    color: "#ffca28",
  ...
  [SkillNames.AWS]: {
    ...
    label: "AWS",
    shortDescription:
      "มักจะเกินไป ทำให้ทุกอย่างซับซ้อนขึ้น จบ! 🌐👨‍💻",
    color: "#ff9900",
  ...
  [SkillNames.VERCEL]: {
    ...
    label: "Vercel",
    shortDescription:
      "บริษัทสามเหลี่ยม ช่วยคุณ deploy แล้วไปสัมผัสหญ้า! 🚀🌿",
    color: "#6cc24a",
