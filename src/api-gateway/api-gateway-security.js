...
class APIGatewaySecurity extends EventEmitter {
    ...
    hasPermission(user, requiredPermission) {
        ...
        for (const roleId of user.roles) {
            ...
            if (role && Array.isArray(role.permissions) && role.permissions.includes(requiredPermission)) {
                return true;
            }
            
            // Check for admin:all permission
            if (role && Array.isArray(role.permissions) && role.permissions.includes('admin:all')) {
                return true;
            }
        }
