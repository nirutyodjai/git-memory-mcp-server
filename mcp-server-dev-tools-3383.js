...
class MCP_DEV-TOOLS_Server {
  constructor() {
    ...
    this.serverId = 'dev-tools-3383';
    this.category = 'dev-tools';
    this.port = 3383;
    this.memoryPath = 'D:\Ai Server\git-memory-mcp-server\.git-memory\servers\dev-tools-3383';
...
const server = new MCP_DEV-TOOLS_Server();
