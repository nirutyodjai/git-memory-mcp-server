...
class MCP_VERSION-CONTROL_Server {
  constructor() {
    this.server = new Server(
      {
        name: 'version-control-3340',
        version: '1.0.0',
      },
      {
        capabilities: {
    ...
    this.serverId = 'version-control-3340';
    this.category = 'version-control';
    this.port = 3340;
    this.memoryPath = 'D:\Ai Server\git-memory-mcp-server\.git-memory\servers\version-control-3340';
...
const server = new MCP_VERSION-CONTROL_Server();
