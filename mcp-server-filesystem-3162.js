...
class MCP_FILESYSTEM_Server {
  constructor() {
    ...
    this.serverId = 'filesystem-3162';
    this.category = 'filesystem';
    this.port = 3162;
    this.memoryPath = 'D:\Ai Server\git-memory-mcp-server\.git-memory\servers\filesystem-3162';
...
server.run().catch(console.error);
    ...
    onSharedDataReceived(dataType, serverId, data, metadata) {
        console.log(`📥 [filesystem-3162] Received ${dataType} from ${serverId}`);
    ...
    onSharedChannelMessage(channel, data) {
        console.log(`📢 [filesystem-3162] Channel message on ${channel}:`, data);
