...
const Textarea = React.forwardRef(({ className, ...props }, ref) => {
    ...
    return (<framer_motion_1.motion.div style={{
      ...
      `,
        ...
        <textarea className={(0, utils_1.cn)(`flex min-h-20 h-28 w-full border-none bg-gray-50 dark:bg-zinc-800 text-black dark:text-white shadow-input rounded-md px-3 py-2 text-sm  file:border-0 file:bg-transparent 
...
//# sourceMappingURL=ace-textarea.js.map