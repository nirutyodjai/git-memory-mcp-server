...
const PinContainer = ({ children, title, href, className, containerClassName, }) => {
    ...
    return (react_1.default.createElement(link_1.default, { className: (0, utils_1.cn)("relative group/pin z-50  cursor-pointer", containerClassName), onMouseEnter: onMouseEnter, onMouseLeave: onMouseLeave, href: href || "/" },
        react_1.default.createElement("div", { style: {
            ...
            react_1.default.createElement("div", { style: {
                ...
                react_1.default.createElement("div", { className: (0, utils_1.cn)(" relative z-50 ", className) }, children))),
...
const PinPerspective = ({ title, href, }) => {
    return (react_1.default.createElement(framer_motion_1.motion.div, { className: "pointer-events-none  w-96 h-80 flex items-center justify-center opacity-0 group-hover/pin:opacity-100 z-[60] transition duration-500" },
        react_1.default.createElement("div", { className: " w-full h-full -mt-7 flex-none  inset-0" },
            react_1.default.createElement("div", { className: "absolute top-0 inset-x-0  flex justify-center" },
                react_1.default.createElement("a", { href: href, target: "_blank", className: "relative flex space-x-2 items-center z-10 rounded-full bg-zinc-950 py-0.5 px-4 ring-1 ring-white/10 " },
                    react_1.default.createElement("span", { className: "relative z-20 text-white text-xs font-bold inline-block py-0.5" }, title),
