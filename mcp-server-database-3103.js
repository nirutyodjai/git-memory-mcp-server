...
class MCP_DATABASE_Server {
  constructor() {
    ...
    this.serverId = 'database-3103';
    this.category = 'database';
    this.port = 3103;
    this.memoryPath = 'D:\Ai Server\git-memory-mcp-server\.git-memory\servers\database-3103';
...
server.run().catch(console.error);
    ...
    onSharedDataReceived(dataType, serverId, data, metadata) {
        console.log(`📥 [database-3103] Received ${dataType} from ${serverId}`);
    ...
    onSharedChannelMessage(channel, data) {
        console.log(`📢 [database-3103] Channel message on ${channel}:`, data);
