...
class MCP_API_Server {
  constructor() {
    ...
    this.serverId = 'api-3212';
    this.category = 'api';
    this.port = 3212;
    this.memoryPath = 'D:\Ai Server\git-memory-mcp-server\.git-memory\servers\api-3212';
...
server.run().catch(console.error);
    ...
    onSharedDataReceived(dataType, serverId, data, metadata) {
        console.log(`📥 [api-3212] Received ${dataType} from ${serverId}`);
    ...
    onSharedChannelMessage(channel, data) {
        console.log(`📢 [api-3212] Channel message on ${channel}:`, data);
